...
object ArticleMocker {
    fun mockChapter1() =
        mutableListOf(
            ...
            ArticleComponent(
                ArticleComponentType.BODY.id, "임신과 출산 시 진료비지원을 받을 수 있도록 정부에서 지원되는 바우처를 ‘임신바우처’라고 해요. 혹여나 유산이나 사산의 경우가 발생하더라도, 기존에 발급받은 임신바우처를 사용할 수 있어요.\n" +
                    "\n" +
            ...
            ArticleComponent(
                ArticleComponentType.BODY.id, "산부인과에서 임신확인검사를 마치고 나면, 병원에서 임산부 등록을 진행해요. 이때 산부인과에 임산부 확인서를 요청할 수 있어요.\n" +
                    "\n" +
            ...
            ArticleComponent(
                ArticleComponentType.CHAPTER_TITLE.id, "Chater 2.\n" +
                    "더욱 편리하게 지원금을 사용하는 방법, 국민행복카드를 발급받아볼까요?"),
            ArticleComponent(
                ArticleComponentType.BODY.id, "국민행복카드를 발급받으면 각종 정부 지원금을 받을 수 있어요. 아이 한 명 당 100만 원을 지원받을 수 있답니다.\n" +
                    "\n" +
