...
import com.lionheart.databinding.ItemCourseWeeklyThumbnailBinding
import com.lionheart.domain.entity.Article

class CourseWeeklyAdapter(private val list: List<Article>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val binding = ItemCourseWeeklyThumbnailBinding.inflate(inflater, parent, false)
...
class CourseWeeklyViewHolder(private val binding: ItemCourseWeeklyThumbnailBinding) :
